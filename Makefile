...
release-next-steps:
	...
	@echo "Next steps:"
	@echo "  1. Open a release PR with package.json, jsr.json, and deno.json."
	@echo "  2. Merge the PR to main and wait for main CI to pass."
	@echo "  3. Create v$(VERSION) on the merged main commit, then push that tag."
	@echo "  4. Let the tag workflow publish npm, publish JSR, and create GitHub Release notes."
